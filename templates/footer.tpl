	...
	<script type="text/javascript"  src="{url}/assets/js/plugins/password-strength-meter.js" async></script>
	<!-- Select Beautifuler -->
	...
	<script type="text/javascript">var xhttp = new XMLHttpRequest(); xhttp.open("GET", "{url}/tasks/cron", true); xhttp.send();</script>
	<script type="text/javascript" src="{url}/assets/js/plugins/sweetalert.min.js"></script>
	<script type="text/javascript">
		function confirmActionDelete(url) {
		  swal({   
				   title: "{textDoYouWantToDeleteThisObject}",
				   type: "warning",   
				   showCancelButton: true,
				   cancelButtonText: "{textClose}",
				   confirmButtonColor: "#DD6B55",   
				   confirmButtonText: "{textYes}",   
				   closeOnConfirm: false 
				 }, function(){   
					swal({
						title: "{textDeleteObject}",
						text: "{textThisObjectWillBeDeleted}",
						type: "success"
					}, 
					function(){
