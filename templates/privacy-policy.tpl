...
<html lang="en">
	...
	<body>
		<div class="page-error">
			<h1><i class="fa fa-key"></i> Our Privacy Policy</h1>
			<div class="row">
				<div class="col-sm-1"></div>
				<div class="col-sm-10">
					<p>This privacy policy ("policy") will help you understand how FirstCloud-Hosting ("us", "we", "our") uses and protects the data you provide to us when you visit and use *.linufy.app("website", "service").
	We reserve the right to change this policy at any given time, of which you will be promptly updated. If you want to make sure that you are up to date with the latest changes, we advise you to frequently visit this page.</p>
					...
					<p>FirstCloud-Hosting will not lease, sell or distribute your personal information to any third parties, unless we have your permission. We might do so if the law forces us. Your personal information will be used when we need to send you promotional materials if you agree to this privacy policy.</p>
				</div>
			</div>	
