...
<html lang="en">
	...
	<body>
						...
						<div class="form-group">
							<div class="col-xs-12">
								<div class="checkbox checkbox-custom">
									...
									<label for="signup">I accept <a target="_blanck" href="<?php echo $_env->filter('escape', $__tpl_vars__url); ?>/CGV.pdf">Terms and Conditions</a></label>
								</div>
							</div>
						</div>
		...
		<?php if (isset($__tpl_vars__errorTermsAndConditions) and $__tpl_vars__errorTermsAndConditions == 'yes') : ?>
		...
		<?php endif; ?>
		<?php if (isset($__tpl_vars__errorApi) and $__tpl_vars__errorApi == 'yes') : ?>
		<script type="text/javascript">
			Swal.fire({
			  title: 'Error!',
			  text: '<?php echo $_env->filter('escape', $__tpl_vars__errorMessage); ?>',
			  type: 'error',
			  confirmButtonText: 'OK'
			})
		</script>
