    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="text-center">
                <h5 class="text-muted m-t-0 font-600"><?php echo $_env->filter('escape', $__tpl_vars__title); ?></h5>
            </div>
            <div class="m-t-40 card-box">
                ...
                <div class="panel-body text-center">
                    <p class="text-muted font-13 m-t-20"> A email has been sent to <b><?php echo $_env->filter('escape', $__tpl_vars__email); ?></b>. Please check for an email from company and click on the included link to active your account. </p>
                </div>
            </div>

            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="text-muted">Return to <a href="signin" class="text-primary m-l-5"><b>Sign in</b></a></p>
                </div>
            </div>
        </section>
    </body>
